/*
  ...
  - A unique constraint covering the columns `[user_id]` on the table `MediaUrl` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `MediaUrl_user_id_key` ON `MediaUrl`(`user_id`);
